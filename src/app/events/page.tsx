      ...
      <div className="mx-auto max-w-7xl relative z-10">
        ...
        >
          ...
          <div className="mb-10 space-y-2 text-slate-400 font-sans text-sm max-w-2xl mx-auto">
            <p className="flex items-center justify-center gap-2"><Calendar className="w-4 h-4 text-[#EAB308]" /> Registration deadline: <span className="text-[#EAB308] font-semibold">Extended  to 12.02.26</span></p>
